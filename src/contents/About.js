...
<p>For twelve weeks in the summer of 2022, I joined PayPal as a Software Engineer. As part of Braintree, a PayPal service, I practiced pair programming on both the server and web SDK team in an Agile environment. I collaborated on implementing the SEPA feature for the JavaScript v3 SDK using Test Driven Development including creating the <a href="https://developer.paypal.com/braintree/docs">docs</a>. I also spearheaded the implementation of the <a href="https://www.github.com/paypal/paypalhttp_java/pull/18">GSON</a> library to replace an inefficient custom serializer. After investigating integration issues from large merchants, I streamlined the help channels service process by identifying user pain points and automating the process with a Slack bot.
</p>
<p> 
During my 2020-2021 gap year, I worked at <a href="https://www.coinhako.com/">Coinhako</a> as a Software Engineer for three months. I was the project lead in automating a user subscription service. I created an API client and categorized subscribers to streamline operations. I also expanded a backend risk evaluation service and created a user-friendly front-end service to accompany it. I also dived into the world of machine learning. I took various courses and created my own projects to unearth the mathematical reasoning behind computations.
</p>
				...
				<div className="row row-content">
					<div className="col col-md-8">
						...
						<ul>
							<li><b><a href="https://www.thedormdigest.com/">thedormdigest</a></b> — Co-founded a blog to share college lifestyle hacks and experience with a focus on food.</li>
						</ul>
						<br></br>
						<h3>Past Projects</h3>
						<ul>
