...
<p> 
During my gap year, I also dived into the world of machine learning. I took various courses and created my own projects to unearth the mathematical reasoning behind computations.
</p>
<p> 
I also worked as a mathematics, social studies, and science tutor. I soon realized how time-intensive it is to write student reports for my six students. Subsequently, I have been working on applying some of the deep learning theories I have read about to automate this process.
</p>
				...
				<div className="row row-content">
					<div className="col col-md-8">
						...
						<ul>
							...
							<li><b>Salude</b> — SheHacks U18 First Place Winner 2019. I designed an application under the theme of "Empowerment" and presented my application to Visa Executives and various entrepreneurs.</li>
						</ul>
					</div>
				</div>
				<Footer />
